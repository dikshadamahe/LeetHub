              ...
              p.each(i, function (e, t) {
                ...
                if (p.isPlainObject(r[n]) && e != o) r = r[n];
                  ...
                  if (!p.isPlainObject(r[t]) || e == o)
                    return (
                      r[t] !== b ? (a = r[t]) : s.error(d.method, i),
                      !1
                    );
                  r = r[t];
                }
                ...
                n.each(function () {
                  ...
                  n.hasClass(m.error) &&
                    ...
                    r
                      ...
                      : a
                      ? e.prop('checked', !1)
                      : (h.verbose('Resetting field value', e, o),
                        e.val(''));
                });
              },
              reset: function () {
                ...
                prompt: function (e, t) {
                  ...
                  return (
                    ...
                    u &&
                      ((i =
                        1 ==
                        (n = r.closest(f.group).find('label').eq(0))
                          .length
                          ? n.text()
                          : r.prop('placeholder') ||
                ...
                field: function (n, e, t) {
                  ...
                  return (
                    n.identifier ||
                      ...
                      (n.identifier = i)),
                    o.prop('disabled')
                      ? (h.debug('Field is disabled. Skipping', i),
                        (r = !0))
                    ...
                    r
                      ? (t &&
                          (h.remove.prompt(i, s), d.onValid.call(o)),
                        !0)
                      : (t &&
                          ((b = b.concat(s)),
                          h.add.prompt(i, s),
      ...
      (F.fn.form.settings = {
        ...
        rules: {
          ...
          contains: function (e, t) {
            return (
              (t = t.replace(
                F.fn.form.settings.regExp.escape,
                '\\$&',
              )),
          ...
          creditCard: function (n, e) {
            ...
            if ('string' == typeof n && 0 !== n.length) {
              ...
              if (
                (t = {
                  number:
                    -1 !== F.inArray(n.length, o.unionPay.length),
          ...
          e.each(function () {
            ...
            (s = {
              ...
              setup: function () {
                s.set.initialLoad(),
                  s.is.indeterminate()
                    ...
                    : (s.debug('Initial value is unchecked'),
                      s.uncheck()),
              ...
              is: {
                ...
                radio: function () {
                  return (
                    d.hasClass(t.radio) || 'radio' == d.attr('type')
                  );
                },
                indeterminate: function () {
                  return (
                    d.prop('indeterminate') !== P &&
                    d.prop('indeterminate')
                  );
                },
                checked: function () {
                ...
                disabled: function () {
                  return (
                    d.prop('disabled') !== P && d.prop('disabled')
                  );
                },
                enabled: function () {
        ...
        return (
          v.each(function () {
            var a,
              ...
              u = v.selector || '',
              d =
                'ontouchstart' in k.documentElement
                  ? 'touchstart'
                  : 'click',
              f = S(this),
              m = this,
            ...
            (s = {
                  ...
                  (e = S.isFunction(e) ? e : function () {}),
                    ...
                    a.transition('is supported')
                      ...
                      : (s.verbose('Hiding dimmer with javascript'),
                        ...
                        a
                          .stop()
                          .fadeOut(s.get.duration(), function () {
                            s.remove.active(),
                              a.removeAttr('style'),
                              e();
                          }));
              ...
              has: {
                dimmer: function () {
                  return r.dimmerName
                    ? 0 <
                        f.find(n.dimmer).filter('.' + r.dimmerName)
                          .length
          ...
          V.each(function (n) {
            ...
            (g = {
                    ...
                    g.is.searchSelection()
                      ? (w
                          ...
                          .on(
                            'mousedown' + x,
                            y.menu,
                            g.event.menu.mousedown,
                          )
                          .on(
                            'mouseup' + x,
                            y.menu,
                            g.event.menu.mouseup,
                          )
                          .on('click' + x, y.icon, g.event.icon.click)
                          .on(
                            'focus' + x,
                            y.search,
                            g.event.search.focus,
                          )
                          .on(
                            'click' + x,
                            y.search,
                ...
                g.has.query() &&
                  ...
                  O.each(function () {
                    ...
                    if ('both' == p.match || 'text' == p.match) {
                      if (
                        -1 !==
                        (e = String(g.get.choiceText(n, !1))).search(
                          a,
                        )
                      )
                    ...
                    if ('both' == p.match || 'value' == p.match) {
                      if (
                        -1 !==
                        (t = String(g.get.choiceValue(n, e))).search(
                          a,
                        )
                      )
                        return o.push(this), !0;
              ...
              filterActive: function () {
                p.useLabels &&
                  O.filter('.' + h.active).addClass(h.filtered);
              },
                  ...
                  blur: function (e) {
                    (t = K.activeElement === this),
                      g.is.searchSelection() &&
                        ...
                        (q ||
                          t ||
                          (p.forceSelection && g.forceSelection(),
                          g.hide())),
                      (i = !1);
                  },
                },
                ...
                test: {
                  toggle: function (e) {
                    ...
                    g.is.bubbledLabelClick(e) ||
                      ...
                      (g.determine.eventOnElement(e, t) &&
                        e.preventDefault());
                  },
                  touch: function (e) {
                ...
                menu: {
                  mutation: function (e) {
                    var t = e[0],
                      ...
                      a =
                        o.is(y.addition) ||
                        0 < o.closest(y.addition).length,
                      r =
                        o.is(y.message) ||
                        0 < o.closest(y.message).length;
                    a || r
                ...
                keydown: function (e) {
                  ...
                  if (g.is.inObject(t, v)) {
                    ...
                    if (
                      ...
                      t == v.pageUp &&
                        (g.scrollPage('up'), e.preventDefault()),
                        t == v.pageDown &&
              ...
              get: {
                ...
                caretPosition: function () {
                  ...
                  return 'selectionStart' in n
                    ...
                    : K.selection
                    ? (n.focus(),
                      (t = (e = K.selection.createRange()).text
                        .length),
                ...
                selectedItem: function () {
                  var e = O.not(y.unselectable).filter(
                    '.' + h.selected,
                  );
              ...
              restore: {
                ...
                defaultText: function () {
                  ...
                  e === g.get.placeholderText
                    ...
                    : (g.debug('Restoring default text', e),
                      g.set.text(e));
                },
                placeholderText: function () {
                ...
                labels: function () {
                  p.allowAdditions &&
                    (p.useLabels ||
                      (g.error(f.labels), (p.useLabels = !0)),
              ...
              set: {
                ...
                scrollPosition: function (e, t) {
                  var n, i, o, a, r, s;
                  (n = (e = e || g.get.selectedItem()).closest(
                    y.menu,
                  )),
                    (i = e && 0 < e.length),
                    (t = t !== J && t),
              ...
              add: {
                ...
                optionValue: function (e) {
                  ...
                  0 <
                    R.find(
                      'option[value="' + g.escape.string(t) + '"]',
                    ).length ||
                    (g.disconnect.selectObserver(),
                    g.is.single() &&
                  ...
                  (p.useLabels && g.has.maxSelections()) ||
                    ('' === e || o
                      ...
                      : (a
                          ...
                          : ((n = g.create.userChoice(e)).prependTo(
                              F,
                            ),
                            g.verbose(
                ...
                value: function (e, t, n) {
                  ...
                  g.has.selectInput()
                    ...
                    : (g.verbose('Removing from delimited values', e),
                      (i = (i = g.remove.arrayValue(e, o)).join(
                        p.delimiter,
                      ))),
                    !1 === p.fireOnInit && g.is.initialLoad()
                      ? g.verbose(
              ...
              has: {
                ...
                minCharacters: function (e) {
                  return (
                    !p.minCharacters ||
                    (e = e !== J ? String(e) : String(g.get.query()))
                      .length >= p.minCharacters
                  );
                },
                ...
                maxSelections: function () {
                  return (
                    p.maxSelections &&
                    g.get.selectionCount() >= p.maxSelections
                  );
                },
              ...
              is: {
                ...
                visible: function (e) {
                  return e
                    ? e.hasClass(h.visible)
                    : F.hasClass(h.visible);
                },
    ...
    (z =
            ...
            (l = {
              ...
              event: {
                ...
                keyboard: function (e) {
                  27 == e.which &&
                    (c.closable
                      ? (l.debug('Escape key pressed hiding modal'),
                        l.hide())
                      : l.debug(
      ...
      (j.fn.modal.settings = {
        ...
        selector: {
          ...
          deny:
            '.actions .negative, .actions .deny, .actions .cancel',
          modal: '.ui.modal',
        },
        error: {
          dimmer:
            ...
            (s = {
              initialize: function () {
                s.verbose('Initializing element'),
                  ...
                  0 < i.displayTime &&
                    setTimeout(s.hide, i.displayTime),
                  s.show();
              },
              destroy: function () {
              ...
              should: {
                show: function () {
                  return i.persist
                    ? (s.debug('Persistent nag is set, can show nag'),
                      !0)
            ...
            (d = {
              ...
              refresh: function () {
                f.popup
                  ? (u = z(f.popup).eq(0))
                  : f.inline &&
                    ((u = b.nextAll(o.popup).eq(0)), (f.popup = u)),
                  f.popup
                  ...
                  c.is('html') &&
                    c[0] !== P[0] &&
                    (d.debug('Setting page as offset parent'),
                    (c = P)),
                ...
                d.debug('Toggling pop-up'),
                  d.is.hidden()
                    ? (d.debug('Popup is hidden, showing pop-up'),
                      d.unbind.close(),
                      d.show())
                    : (d.debug('Popup is visible, hiding pop-up'),
                      d.hide());
              },
              show: function (e) {
                if (
              ...
              get: {
                html: function () {
                  return (
                    h.removeData(p.html), h.data(p.html) || f.html
                  );
                },
                title: function () {
                  return (
                    h.removeData(p.title), h.data(p.title) || f.title
                  );
                },
                content: function () {
                  return (
              ...
              set: {
                ...
                variation: function (e) {
                  (e = e || d.get.variation()) &&
                    d.has.popup() &&
                    (d.verbose('Adding variation to popup', e),
                    u.addClass(e));
                },
                visible: function () {
              ...
              remove: {
                ...
                variation: function (e) {
                  (e = e || d.get.variation()) &&
                    (d.verbose('Removing variation', e),
                    u.removeClass(e));
                },
                visible: function () {
              ...
              should: {
                centerArrow: function (e) {
                  return (
                    !d.is.basic() &&
                    e.target.width <= 2 * f.arrowPixelsFromEdge
                  );
                },
              },
              is: {
                ...
                svg: function (e) {
                  return (
                    d.supports.svg() &&
                    e instanceof SVGGraphicsElement
                  );
                },
                basic: function () {
            ...
            get: {
              ...
              randomValue: function () {
                return (
                  ...
                  Math.floor(
                    Math.random() * i.random.max + i.random.min,
                  )
                );
              },
          ...
          E(this).each(function () {
            ...
            (f = {
              ...
              write: {
                cache: function (e, t) {
                  var n =
                    h.data(u.cache) !== D ? h.data(u.cache) : {};
                  c.cache &&
                    (f.verbose(
              ...
              generateResults: function (e) {
                ...
                var t = c.templates[c.type],
                  ...
                  i =
                    E.isArray(e[a.results]) &&
                    0 < e[a.results].length,
                  o = '';
                return (
                  n || i
                    ? (0 < c.maxResults &&
              ...
              set: {
                ...
                nextSide: function (e) {
                  (g = e),
                    ...
                    (g = m.index(o)),
                    0 === o.length &&
                      (a.set.defaultSide(), a.error(n.side)),
            ...
            (c = {
              ...
              event: {
                clickaway: function (e) {
                  var t =
                      0 < v.find(e.target).length || v.is(e.target),
                    n = p.is(e.target);
                  t &&
              ...
              is: {
                ...
                mobile: function () {
                  ...
                  return e.match(o.mobile)
                    ? (c.verbose('Browser was found to be mobile', e),
                      !0)
                    : (c.verbose(
              ...
              set: {
                ...
                containerSize: function () {
                  ...
                  'HTML' === e || 'body' == e
                    ? d.determineContainer()
                    : Math.abs(
                        i.outerHeight() - d.cache.context.height,
                      ) > f.jitter &&
                      (d.debug(
            ...
            (b = {
              ...
              event: {
                ...
                history: {
                  change: function (e) {
                    var t =
                        e.pathNames.join('/') || b.get.initialPath(),
              ...
              remove: {
                ...
                looping: function () {
                  f.debug('Transitions are no longer looping'),
                    f.is.looping() &&
                      (f.reset(), m.removeClass(d.looping));
                },
                transition: function () {
                  ...
                  var t = e || u.animation,
                    n =
                      f.can.transition() && !f.has.direction()
                        ...
                        : '';
                  return (
                    d.animating + ' ' + d.transition + ' ' + n + t
                  );
                },
                currentAnimation: function () {
                  return (
                    !(!f.cache || f.cache.animation === S) &&
                    f.cache.animation
                  );
                },
          ...
          (l = {
            ...
            query: function () {
              if (l.is.disabled())
                ...
                if (
                  ...
                  c.serializeForm &&
                    (c.data = l.add.formData(c.data)),
                  !1 === (r = l.get.settings()))
                )
                  return (
                    (l.cancelled = !0), void l.error(u.beforeSend)
                  );
                if (
                  ((l.cancelled = !1),
            ...
            is: {
              ...
              validResponse: function (e) {
                return l.is.expectingJSON() &&
                  P.isFunction(c.successTest)
                  ? (l.debug(
                    ...
                    c.successTest(e)
                      ? (l.debug('Response passed success test', e),
                        !0)
                      : (l.debug('Response failed success test', e),
                        !1))
                  : (l.verbose(
                  ...
                  o &&
                    ...
                    e &&
                      ...
                      P.each(e, function (e, t) {
                        ...
                        if (i === F)
                          return (
                            l.error(u.requiredParameter, n, o),
                            (o = !1)
                          );
            ...
            (s = {
              ...
              destroy: function () {
                s.verbose('Destroying previous module'),
                  ...
                  'fixed' == o.type &&
                    (s.resetFixed(), s.remove.placeholder()),
                ...
                if (e && t) o.onPassed[e] = t;
                  ...
                  n.passing &&
                    P.each(o.onPassed, function (e, t) {
                      n.bottomVisible ||
                      n.pixelsPassed > s.get.pixelsPassed(e)
                        ? s.execute(t, e)
              ...
              save: {
                ...
                elementPosition: function () {
                  ...
                  return (
                    ...
                    s.is.verticallyScrollableContext() &&
                      (e.offset.top +=
                        m.scrollTop() - m.offset().top),
                    s.is.horizontallyScrollableContext() &&
                      (e.offset.left +=
                        m.scrollLeft - m.offset().left),
                    (s.cache.element = e)
                  );
                },
                ...
                screenCalculations: function () {
                  ...
                  return (
                    ...
                    (s.cache.screen.bottom =
                      e + s.cache.screen.height),
                    s.cache.screen
                  );
                },
                screenSize: function () {
              ...
              get: {
                ...
                occurred: function (e) {
                  return (
                    (s.cache.occurred !== O && s.cache.occurred[e]) ||
                    !1
                  );
                },
                direction: function () {
                ...
                screenSize: function () {
                  return (
                    s.cache.screen === O && s.save.screenSize(),
                    s.cache.screen
                  );
                },
                scroll: function () {
                  return (
                    s.cache.scroll === O && s.save.scroll(),
                    s.cache.scroll
                  );
                },
                lastScroll: function () {
